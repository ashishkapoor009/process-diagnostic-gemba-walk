...
STRUCTURING_INSTRUCTION = (
    ...
    "each tagged with the correct step_number. proposed_by_agent must be 'AI Agentic Agent'."
)
...
def run_ai_agent(metadata: ProcessMetadata, diagnostics: list[ProcessStepDiagnostic]) -> tuple[list[Recommendation], str]:
    ...
    for r in result.recommendations:
        r.proposed_by_agent = "AI Agentic Agent"
    logger.info(f"AI Agentic Agent produced {len(result.recommendations)} recommendations")
